...
public class StartScreen extends JFrame implements ActionListener {
    ...
    public StartScreen() {
       ...
       // Load the background image
        backgroundImage = new ImageIcon(getClass().getResource("../rambo/map/startl.png")).getImage();
    ...
    private JButton createStyledButton(String text) {
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(255, 73, 73)); // Change to a lighter blue on hover
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(255, 73, 73)); // Reset to original color
            }
        });
