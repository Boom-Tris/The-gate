...
public class ScoreIndicator {
    ...
    private void loadCoinImage() {
        try {
            ...
            BufferedImage spritesheet = ImageIO.read(getClass().getResource("../item/coin4_16x16.png"));
    ...
    public void draw(Graphics g) {
        g.drawImage(coinImage, 175, 35, coinSize, coinSize, null); // Draw the coin image
        g.setColor(Color.WHITE); // Set text color to white
        g.setFont(customFont); // Use the custom font loaded in the constructor
        g.drawString("Score: " + character.getScore(), 230, 60); // Draw the score next to the coin image
    }
