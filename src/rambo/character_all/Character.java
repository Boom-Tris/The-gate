 ...
 private SoundManager soundManager;
    ...
    public Character() {
        ...
        try {
            ...
            // Load death frame
            deathFrame = ImageIO.read(getClass().getResource("../character/rambo-death-4.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
private void checkCollision(List<Rectangle> hitboxes) {
    ...
    public void jump() {
        if (!jumping && !dead) {
            jumping = true;
           soundManager.playSound("mixkit-player-jumping-in-a-video-game-2043.wav");
        }
    }
    ...
    public void takeDamage(int par) {
        if (!dead) {
            ...
            if (health <= 0) {
               ...
               soundManager.playSound("mixkit-game-over-trombone-1940.wav");
                die(); // Trigger death
...
if (!onGround) {
    ...
    public void addScore(int points) {
         soundManager.playSound("mixkit-game-success-alert-2039.wav");
