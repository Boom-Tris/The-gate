...
public class Coin implements Runnable {
    ...
    private static final int FRAME_TIME = 60; // Frame change time in milliseconds
    ...
    private void loadFrames() {
        ...
        try {
            BufferedImage coinSheet = ImageIO.read(getClass().getResource("../item/coin4_16x16.png"));
